...
def rpsGame(args):
    ...
    if args[0] == "new":
        ...
        for line in lines:
            file.write(line+"\n")
        file.close()
        sendMessage(message="You have been challenged to a game of Rock/Paper/Scissors! To make your move, type exactly, replacing rock with paper or scissors: rps "+gameName+" rock",recipientOfSendMessage=args[1],mode="sms")
