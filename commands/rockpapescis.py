...
import random
from profiler import getProfileParse

def rpsGame(args,recipient = ""):
    __name__ = "rpsGame"
    ...
    if args[0] != "new":
        ...
        print("AMove",playerAMove,"BMove",playerBMove)
        ...
        playerAMove = playerAMove.strip()
        playerBMove = playerBMove.strip()
    ...
    if args[0] == "new":
        ...
        for line in lines:
            file.write(line+"\n")
        file.close()
        sendMessage(message="You have been challenged to a game of Rock/Paper/Scissors! To make your move, type exactly, replacing rock with paper or scissors: rps "+gameName+" rock",
                    recipientOfSendMessage=getProfileParse(args[1]),mode="sms")
        return "Challenge sent. Game name: "+gameName
